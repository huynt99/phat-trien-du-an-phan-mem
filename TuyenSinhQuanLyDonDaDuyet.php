...
<body id="page-top">
    ...
    <?php include("menu.php");?>
                            ...
                            <div class="container-fluid"><a class="navbar-brand" href="#">Tuyển sinh</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-2"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                                <div
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="nav-item" role="presentation"><a class="nav-link" href="TuyenSinhDonTrungTuyen.php">Đơn trúng tuyển</a></li>
        ...
        <div class="container">
            <div style="margin-top: 20px;margin-bottom: 20px;"><select><optgroup label="Thứ tự sắp xếp"><option value="12">Điểm tăng dần</option><option value="13">Điểm giảm dần</option></optgroup></select><select><optgroup label="Cơ sở đào tạo"><option value="12" selected="">Cơ sở 1 Hà Nội</option><option value="13">Cơ sở 2 Phố hiển</option><option value="14">Cơ sở 3 Thành phố Hồ Chí Minh</option></optgroup></select><select><optgroup label="Nguyện vọng"><option value="12" selected="">Nguyện vọng 1</option><option value="13">Nguyện vọng 2</option><option value="14">Nguyện vọng 20</option></optgroup></select><select><optgroup label="Theo nhóm ngành xét tuyển"><option value="12" selected="">Công nghệ thông tin</option><option value="13">Y học cổ truyền</option><option value="14">Dược</option></optgroup></select></div>
            <div><span style="margin: 10px;">Nhập chỉ tiêu:</span><input type="number"></div>
            <div>
                <hr><button id="btnLoc" class="btn btn-primary" type="button" style="background-color: rgb(96,111,248);margin: 5px;">Lọc thí sinh</button></div>
        </div>
        <div class="container">
            <div class="table-responsive table-bordered table table-hover table-bordered results">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                         <?php
                        $qr = "SELECT thongtintlisinh.mathisinh,thongtintlisinh.hoten,thongtintlisinh.ngaysinh,thongtintlisinh.chungminhthu,province._name,thongtintlisinh.gioitinh FROM `thongtintlisinh`,`province` WHERE thongtintlisinh.idtinh = province.id AND thongtintlisinh.trangthai = 1";
                        ...
                        <tr>
                            ...
                            <td>{tinh}</td>
                            <td>{gioitinh}</td>
                            <td class="text-center"><a class="btn btn-success" role="button" style="margin-left: 5px;" href="TuyenSinhChiTietDon.php?id={id}"><i class="fa fa-folder-open-o" style="font-size: 15px;"></i></a><a class="btn btn-success" role="button" style="margin-left: 5px;" href="updatethisinhtrungtuyen.php?mathisinh={id}"><i class="fa fa-check-square-o" style="font-size: 15px;"></i></a><a class="btn btn-danger" role="button" style="margin-left: 5px;" href="xoathisinh.php?mathisinh={id}&check=1"><i class="fa fa-trash" style="font-size: 15px;"></i></a>
