                            ...
                            <div class="container-fluid"><a class="navbar-brand" href="#!">Tuyển sinh</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-2"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                                <div
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="nav-item" role="presentation"><a class="nav-link" href="TuyenSinhQuanLyDonDaDuyet.php">Đơn đã xét duyệt<br></a></li>
                                        <li class="nav-item" role="presentation"><a class="nav-link active" href="TuyenSinhDonTrungTuyen.php"><br>Đơn trúng tuyển<br><br></a></li>
                                        <li class="nav-item" role="presentation"><a class="nav-link" href="TuyenSinhQuanLyDonDaLoaiBo.php">Đơn loại bỏ</a></li>
                                    </ul>
                            </div>
                    </div>
                    </nav>
        ...
        <div class="container">
            <div class="table-responsive table-bordered table table-hover table-bordered results">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                          <?php
                        $qr = "SELECT thongtintlisinh.mathisinh,thongtintlisinh.hoten,thongtintlisinh.ngaysinh,thongtintlisinh.chungminhthu,province._name,thongtintlisinh.gioitinh FROM `thongtintlisinh`,`province` WHERE thongtintlisinh.idtinh = province.id AND thongtintlisinh.trangthai = 3";
