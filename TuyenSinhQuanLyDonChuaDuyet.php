            ...
            <div class="table-responsive table-bordered table table-hover table-bordered results">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <?php
                        $qr = "SELECT thongtintlisinh.mathisinh,thongtintlisinh.hoten,thongtintlisinh.ngaysinh,thongtintlisinh.chungminhthu,province._name,thongtintlisinh.gioitinh FROM `thongtintlisinh`,`province` WHERE thongtintlisinh.idtinh = province.id AND thongtintlisinh.trangthai = 0";
